...
This project is a maintained fork of https://github.com/banzaicloud/terraform-provider-k8s to make custom configuration and apply it for our projects.
...
```
go get -u github.com/devsu/terraform-provider-k8s
```
